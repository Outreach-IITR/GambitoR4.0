    ...
    <div className='w-screen h-screen bg-slate-300 flex justify-center items-center'>
      <div className='bg-white h-[400px] w-[85%] flex flex-col justify-center items-center rounded-[0.9rem] md:h-[450px] md:w-[50%] lg:w-[39%] lg:h-[490px] lg:rounded-[1.5rem]'>
        ...
        <div className='mt-2 text-center md:mt-4'>
          <p className='md:text-[1.2rem]'>Didn’t get the code? <a href="#" className='text-[#AF0034] underline underline-offset-4' onClick={handleResend}>Click to resend</a></p>
        </div>
        <div className='text-center mt-8 flex flex-row w-[80%] justify-center'>
          <button className='w-28 h-8 mr-8 text-center text-[#AF0034] border-2 border-[#AF0034] rounded-[0.2rem]' onClick={handleCancel}>Cancel</button>
          <button className='w-28 h-8 mb-4 text-center text-white bg-[#AF0034] border-2 border-[#AF0034] rounded-[0.2rem]' onClick={handleVerify}>Verify</button>
        </div>
      </div>
    </div>
  );
