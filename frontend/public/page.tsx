    ...
    return(
        <div className="pt-[2vw] " >
                ...
                <div className="flex items-center">
                        <a href="/Brochure.pdf" download>
                            <button className="flex items-center border-2 rounded-[7.2px] border-black sm:w-[305px] sm:h-[56px] p-[0.5em]  ">
                                ...
                                <h1 className="sm:text-[25.5px] font-semibold sm:w-[247.5px] sm:h-[37px] text-[#A50034]">Download Brochure</h1>
            ...
            <div className='flex flex-col  items-center relative z-[1] mx-1'>
                <h1 style={Headingcss} className="text-[30px] sm:text-[96px] md:text-8xl font-bold text-center my-[2rem]">Website is under <span className="text-[#A50034]" >construction</span> !</h1>
                <h1 className="text-[17px] w-[90%] sm:text-[40px] md:text-4xl font-semibold mb-[4rem] text-center md:w-[55%]">Secure your spot and be the first to experience our exciting things by <span className="text-[#A50034]">pre-registering</span> through the following link!</h1>
                {/* <Image alt='' src={heading} className="pb-[2rem]"/> */}
                {/* <Image alt='' src={ptext} className="sm:pb-[3.5rem] pb-[2rem]"/> */}
                <a href="/preregistration">
                    <div className="sm:border-4 border-2 rounded-xl border-[#A50034] h-[39px] w-[156px] cursor-pointer sm:h-[61px] sm:w-[277px] mb-[1rem] flex items-center justify-center  " >
